      ...
      <Card>
        <CardContent className="p-8 text-center space-y-4">
          ...
          <p className="text-sm text-muted-foreground">
            We hit an unexpected error loading this page. Try again, or go back to the home page.
          </p>
          ...
          {error.digest && (
            <p className="text-xs text-muted-foreground font-mono pt-2">Error ID: {error.digest}</p>
          )}
        </CardContent>
      </Card>
    </div>
